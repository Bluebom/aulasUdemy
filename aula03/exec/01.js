...
// document.body.innerHTML += `<p class='nome'>Qual o primeiro índice da letra "n" no seu nome? ${nome.indexOf('n')}</p>`
// document.body.innerHTML += `<p class='nome'>Qual o último índice da letra "n" no seu nome? ${nome.lastIndexOf('n')}</p>`
